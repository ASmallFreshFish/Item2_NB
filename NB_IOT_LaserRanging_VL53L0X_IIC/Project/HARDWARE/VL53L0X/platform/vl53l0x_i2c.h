...
#define VL_SDA_IN()  {GPIOA->MODER &=0XFFFF3FFF;GPIOA->PUPDR &=0XFFFF3FFF;}
#define VL_SDA_OUT() {GPIOA->MODER &=0XFFFF3FFF;GPIOA->MODER |= 4<<8;GPIOA->OTYPER &= 0XFFFFFFDF;}

//IO操作函数	 
#define VL_IIC_SCL    PAout(4) 		//SCL
#define VL_IIC_SDA    PAout(5) 		//SDA	 
#define VL_READ_SDA   PAin(5) 		    //输入SDA 
