...
//press strain upload
//0312
void test_upload_buf_press_stra_frame(void)
{
	u8 loc = 0;
	u8 t;
	u8 pp[2];
	...
	//04DD383638373434303339373233363539FD0103
	if(g_weight.sta)
	{
		//BUS1:MESSAGE_ID
...
void test_upload_press_stra_handle(void)
{
	if(g_weight.sta)
	{
...
void upload_buf_gesture_frame(void)
{
	...
	if(g_gesture.sta)
	{
		...
		{
			case UP_GESTURE:
				strncat(sendata_gesture,"01",2);
				break;
			case DOWN_GESTURE:
				strncat(sendata_gesture,"02",2);
				break;
			case LEFT_GESTURE:
				strncat(sendata_gesture,"03",2);
				break;
			case RIGHT_GESTURE:
				strncat(sendata_gesture,"04",2);
				break;
			case FAR_GESTURE:
				strncat(sendata_gesture,"05",2);
				break;
			case NEAR_GESTURE:
				strncat(sendata_gesture,"06",2);
				break;
			default:
				strncat(sendata_gesture,"00",2);
				break;
		}
		loc += 2;
